...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_callback_query(
        ...
        # --- Plugin human decisions (hd:token:choice-index) ---
        # This stays ahead of every picker/extension callback path so opaque
        # decision tokens can never be claimed by a plugin callback handler.
